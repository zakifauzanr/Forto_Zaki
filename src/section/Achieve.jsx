        ...
        <h1 className='text-2xl font-mono font-bold my-3 text-center'>My Achieve</h1>
            ...
            <div>
                <h1 className="text-lg font-semibold">
                    Delegasi Istanbul Youth Summit
                </h1>
                <ol className="list-decimal mx-10 text-md font-thin text-slate-200">
            ...
            <div className='time-experience'>21 Apr 2021 – 23 Apr 2021 </div>
            </div>
            <div className="flex justify-between items-center">
            <div>
                <h1 className="text-lg font-semibold">
            ...
            <div className='time-experience'>23 Apr 2021 – 24 Apr 2021 </div>
            </div>
        </div>
        </div>
    )
